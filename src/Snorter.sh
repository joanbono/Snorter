...
function barnyard2_install() {
	...
	sudo apt-get install -y --force-yes mysql-server default-libmysqlclient-dev mysql-client autoconf libtool libdnet checkinstall yagiuda libdnet-dev locate
